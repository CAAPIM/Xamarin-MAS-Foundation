...
namespace Sun.Security.X509 {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateIssuerUniqueIdentity']"
	[global::Android.Runtime.Register ("sun/security/x509/CertificateIssuerUniqueIdentity", DoNotGenerateAcw=true)]
	public partial class CertificateIssuerUniqueIdentity : global::Java.Lang.Object, global::Sun.Security.X509.ICertAttrSet {


		// Metadata.xml XPath field reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateIssuerUniqueIdentity']/field[@name='ID']"
		[Register ("ID")]
		public const string Id = (string) "id";

		// Metadata.xml XPath field reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateIssuerUniqueIdentity']/field[@name='IDENT']"
		[Register ("IDENT")]
		public const string Ident = (string) "x509.info.issuerID";
		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("sun/security/x509/CertificateIssuerUniqueIdentity", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (CertificateIssuerUniqueIdentity); }
		}

		protected CertificateIssuerUniqueIdentity (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_io_InputStream_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateIssuerUniqueIdentity']/constructor[@name='CertificateIssuerUniqueIdentity' and count(parameter)=1 and parameter[1][@type='java.io.InputStream']]"
		[Register (".ctor", "(Ljava/io/InputStream;)V", "")]
		public unsafe CertificateIssuerUniqueIdentity (global::System.IO.Stream @in)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (CertificateIssuerUniqueIdentity)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateIssuerUniqueIdentity']/constructor[@name='CertificateIssuerUniqueIdentity' and count(parameter)=1 and parameter[1][@type='sun.security.util.DerInputStream']]"
		[Register (".ctor", "(Lsun/security/util/DerInputStream;)V", "")]
		public unsafe CertificateIssuerUniqueIdentity (global::Sun.Security.Util.DerInputStream @in)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
		...
		static IntPtr id_ctor_Lsun_security_x509_UniqueIdentity_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateIssuerUniqueIdentity']/constructor[@name='CertificateIssuerUniqueIdentity' and count(parameter)=1 and parameter[1][@type='sun.security.x509.UniqueIdentity']]"
		[Register (".ctor", "(Lsun/security/x509/UniqueIdentity;)V", "")]
		public unsafe CertificateIssuerUniqueIdentity (global::Sun.Security.X509.UniqueIdentity id)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
			...
			try {
				...
				if (((object) this).GetType () != typeof (CertificateIssuerUniqueIdentity)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Lsun/security/x509/UniqueIdentity;)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, "(Lsun/security/x509/UniqueIdentity;)V", __args);
					return;
				}

				if (id_ctor_Lsun_security_x509_UniqueIdentity_ == IntPtr.Zero)
					id_ctor_Lsun_security_x509_UniqueIdentity_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Lsun/security/x509/UniqueIdentity;)V");
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Lsun_security_x509_UniqueIdentity_, __args),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, class_ref, id_ctor_Lsun_security_x509_UniqueIdentity_, __args);
			} finally {
			}
		}
...
#pragma warning disable 0169
		...
		{
			global::Sun.Security.X509.CertificateIssuerUniqueIdentity __this = global::Java.Lang.Object.GetObject<global::Sun.Security.X509.CertificateIssuerUniqueIdentity> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Java.Util.IEnumeration Elements {
			// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateIssuerUniqueIdentity']/method[@name='getElements' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Name {
			// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateIssuerUniqueIdentity']/method[@name='getName' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateIssuerUniqueIdentity']/method[@name='delete' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateIssuerUniqueIdentity']/method[@name='encode' and count(parameter)=1 and parameter[1][@type='java.io.OutputStream']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateIssuerUniqueIdentity']/method[@name='get' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateIssuerUniqueIdentity']/method[@name='set' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.Object']]"
