...
namespace Sun.Security.X509 {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='sun.security.x509']/class[@name='RFC822Name']"
	[global::Android.Runtime.Register ("sun/security/x509/RFC822Name", DoNotGenerateAcw=true)]
	public partial class RFC822Name : global::Java.Lang.Object, global::Sun.Security.X509.IGeneralNameInterface {
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("sun/security/x509/RFC822Name", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (RFC822Name); }
		}

		protected RFC822Name (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='sun.security.x509']/class[@name='RFC822Name']/constructor[@name='RFC822Name' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;)V", "")]
		public unsafe RFC822Name (string name)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (RFC822Name)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Sun.Security.X509.RFC822Name __this = global::Java.Lang.Object.GetObject<global::Sun.Security.X509.RFC822Name> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe string Name {
			// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='RFC822Name']/method[@name='getName' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe int Type {
			// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='RFC822Name']/method[@name='getType' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='RFC822Name']/method[@name='constrains' and count(parameter)=1 and parameter[1][@type='sun.security.x509.GeneralNameInterface']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='RFC822Name']/method[@name='encode' and count(parameter)=1 and parameter[1][@type='sun.security.util.DerOutputStream']]"
...
#pragma warning disable 0169
		static Delegate GetParseName_Ljava_lang_String_Handler ()
		{
			if (cb_parseName_Ljava_lang_String_ == null)
				cb_parseName_Ljava_lang_String_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_ParseName_Ljava_lang_String_);
			return cb_parseName_Ljava_lang_String_;
		}

		static void n_ParseName_Ljava_lang_String_ (IntPtr jnienv, IntPtr native__this, IntPtr native_name)
		{
			global::Sun.Security.X509.RFC822Name __this = global::Java.Lang.Object.GetObject<global::Sun.Security.X509.RFC822Name> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			string name = JNIEnv.GetString (native_name, JniHandleOwnership.DoNotTransfer);
			__this.ParseName (name);
		}
#pragma warning restore 0169

		static IntPtr id_parseName_Ljava_lang_String_;
		// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='RFC822Name']/method[@name='parseName' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register ("parseName", "(Ljava/lang/String;)V", "GetParseName_Ljava_lang_String_Handler")]
		public virtual unsafe void ParseName (string name)
		{
			if (id_parseName_Ljava_lang_String_ == IntPtr.Zero)
				id_parseName_Ljava_lang_String_ = JNIEnv.GetMethodID (class_ref, "parseName", "(Ljava/lang/String;)V");
			IntPtr native_name = JNIEnv.NewString (name);
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (native_name);
				...
				if (((object) this).GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_parseName_Ljava_lang_String_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "parseName", "(Ljava/lang/String;)V"), __args);
			} finally {
				JNIEnv.DeleteLocalRef (native_name);
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='RFC822Name']/method[@name='subtreeDepth' and count(parameter)=0]"
