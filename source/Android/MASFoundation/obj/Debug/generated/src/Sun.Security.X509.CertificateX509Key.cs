...
namespace Sun.Security.X509 {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateX509Key']"
	[global::Android.Runtime.Register ("sun/security/x509/CertificateX509Key", DoNotGenerateAcw=true)]
	public partial class CertificateX509Key : global::Java.Lang.Object, global::Sun.Security.X509.ICertAttrSet {


		// Metadata.xml XPath field reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateX509Key']/field[@name='IDENT']"
		[Register ("IDENT")]
		public const string Ident = (string) "x509.info.key";

		// Metadata.xml XPath field reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateX509Key']/field[@name='KEY']"
		[Register ("KEY")]
		public const string Key = (string) "value";
		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("sun/security/x509/CertificateX509Key", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (CertificateX509Key); }
		}

		protected CertificateX509Key (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_io_InputStream_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateX509Key']/constructor[@name='CertificateX509Key' and count(parameter)=1 and parameter[1][@type='java.io.InputStream']]"
		[Register (".ctor", "(Ljava/io/InputStream;)V", "")]
		public unsafe CertificateX509Key (global::System.IO.Stream @in)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (CertificateX509Key)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateX509Key']/constructor[@name='CertificateX509Key' and count(parameter)=1 and parameter[1][@type='java.security.PublicKey']]"
		[Register (".ctor", "(Ljava/security/PublicKey;)V", "")]
		public unsafe CertificateX509Key (global::Java.Security.IPublicKey key)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateX509Key']/constructor[@name='CertificateX509Key' and count(parameter)=1 and parameter[1][@type='sun.security.util.DerInputStream']]"
		[Register (".ctor", "(Lsun/security/util/DerInputStream;)V", "")]
		public unsafe CertificateX509Key (global::Sun.Security.Util.DerInputStream @in)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
...
#pragma warning disable 0169
		...
		{
			global::Sun.Security.X509.CertificateX509Key __this = global::Java.Lang.Object.GetObject<global::Sun.Security.X509.CertificateX509Key> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Java.Util.IEnumeration Elements {
			// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateX509Key']/method[@name='getElements' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Name {
			// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateX509Key']/method[@name='getName' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateX509Key']/method[@name='delete' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateX509Key']/method[@name='encode' and count(parameter)=1 and parameter[1][@type='java.io.OutputStream']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateX509Key']/method[@name='get' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateX509Key']/method[@name='set' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.Object']]"
