...
namespace Com.CA.Mas.Core.Registration {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.ca.mas.core.registration']/class[@name='RegistrationServerException']"
	[global::Android.Runtime.Register ("com/ca/mas/core/registration/RegistrationServerException", DoNotGenerateAcw=true)]
	public partial class RegistrationServerException : global::Com.CA.Mas.Core.Error.MAGServerException {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/ca/mas/core/registration/RegistrationServerException", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (RegistrationServerException); }
		}

		protected RegistrationServerException (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Lcom_ca_mas_core_error_MAGServerException_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.ca.mas.core.registration']/class[@name='RegistrationServerException']/constructor[@name='RegistrationServerException' and count(parameter)=1 and parameter[1][@type='com.ca.mas.core.error.MAGServerException']]"
		[Register (".ctor", "(Lcom/ca/mas/core/error/MAGServerException;)V", "")]
		public unsafe RegistrationServerException (global::Com.CA.Mas.Core.Error.MAGServerException e)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (RegistrationServerException)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.ca.mas.core.registration']/class[@name='RegistrationServerException']/constructor[@name='RegistrationServerException' and count(parameter)=4 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='java.lang.String'] and parameter[4][@type='java.lang.String']]"
		[Register (".ctor", "(IILjava/lang/String;Ljava/lang/String;)V", "")]
		public unsafe RegistrationServerException (int errorCode, int status, string contentType, string detailMessage)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Throwable) this).Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.ca.mas.core.registration']/class[@name='RegistrationServerException']/constructor[@name='RegistrationServerException' and count(parameter)=5 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='java.lang.String'] and parameter[4][@type='java.lang.String'] and parameter[5][@type='java.lang.Throwable']]"
		[Register (".ctor", "(IILjava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V", "")]
		public unsafe RegistrationServerException (int errorCode, int status, string contentType, string detailMessage, global::Java.Lang.Throwable throwable)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Throwable) this).Handle != IntPtr.Zero)
				return;
