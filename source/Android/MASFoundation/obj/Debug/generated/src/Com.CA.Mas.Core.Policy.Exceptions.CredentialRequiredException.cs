...
namespace Com.CA.Mas.Core.Policy.Exceptions {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.ca.mas.core.policy.exceptions']/class[@name='CredentialRequiredException']"
	[global::Android.Runtime.Register ("com/ca/mas/core/policy/exceptions/CredentialRequiredException", DoNotGenerateAcw=true)]
	public partial class CredentialRequiredException : global::Com.CA.Mas.Core.Error.MAGStateException {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/ca/mas/core/policy/exceptions/CredentialRequiredException", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (CredentialRequiredException); }
		}

		protected CredentialRequiredException (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.ca.mas.core.policy.exceptions']/class[@name='CredentialRequiredException']/constructor[@name='CredentialRequiredException' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe CredentialRequiredException ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (CredentialRequiredException)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.ca.mas.core.policy.exceptions']/class[@name='CredentialRequiredException']/constructor[@name='CredentialRequiredException' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;)V", "")]
		public unsafe CredentialRequiredException (string detailMessage)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Throwable) this).Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.ca.mas.core.policy.exceptions']/class[@name='CredentialRequiredException']/constructor[@name='CredentialRequiredException' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.Throwable']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/lang/Throwable;)V", "")]
		public unsafe CredentialRequiredException (string detailMessage, global::Java.Lang.Throwable throwable)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Throwable) this).Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.ca.mas.core.policy.exceptions']/class[@name='CredentialRequiredException']/constructor[@name='CredentialRequiredException' and count(parameter)=1 and parameter[1][@type='java.lang.Throwable']]"
		[Register (".ctor", "(Ljava/lang/Throwable;)V", "")]
		public unsafe CredentialRequiredException (global::Java.Lang.Throwable throwable)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Throwable) this).Handle != IntPtr.Zero)
				return;
