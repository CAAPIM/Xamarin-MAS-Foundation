...
namespace Sun.Security.X509 {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateValidity']"
	[global::Android.Runtime.Register ("sun/security/x509/CertificateValidity", DoNotGenerateAcw=true)]
	public partial class CertificateValidity : global::Java.Lang.Object, global::Sun.Security.X509.ICertAttrSet {


		// Metadata.xml XPath field reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateValidity']/field[@name='IDENT']"
		[Register ("IDENT")]
		public const string Ident = (string) "x509.info.validity";

		// Metadata.xml XPath field reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateValidity']/field[@name='NOT_AFTER']"
		[Register ("NOT_AFTER")]
		public const string NotAfter = (string) "notAfter";

		// Metadata.xml XPath field reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateValidity']/field[@name='NOT_BEFORE']"
		[Register ("NOT_BEFORE")]
		public const string NotBefore = (string) "notBefore";
		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("sun/security/x509/CertificateValidity", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (CertificateValidity); }
		}

		protected CertificateValidity (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateValidity']/constructor[@name='CertificateValidity' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe CertificateValidity ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (CertificateValidity)) {
					SetHandle (
		...
		static IntPtr id_ctor_Ljava_util_Date_Ljava_util_Date_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateValidity']/constructor[@name='CertificateValidity' and count(parameter)=2 and parameter[1][@type='java.util.Date'] and parameter[2][@type='java.util.Date']]"
		[Register (".ctor", "(Ljava/util/Date;Ljava/util/Date;)V", "")]
		public unsafe CertificateValidity (global::Java.Util.Date notBefore, global::Java.Util.Date notAfter)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
			...
			try {
				...
				__args [0] = new JValue (notBefore);
				__args [1] = new JValue (notAfter);
				if (((object) this).GetType () != typeof (CertificateValidity)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Ljava/util/Date;Ljava/util/Date;)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, "(Ljava/util/Date;Ljava/util/Date;)V", __args);
					return;
				}

				if (id_ctor_Ljava_util_Date_Ljava_util_Date_ == IntPtr.Zero)
					id_ctor_Ljava_util_Date_Ljava_util_Date_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Ljava/util/Date;Ljava/util/Date;)V");
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Ljava_util_Date_Ljava_util_Date_, __args),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, class_ref, id_ctor_Ljava_util_Date_Ljava_util_Date_, __args);
			} finally {
			}
		}

		static IntPtr id_ctor_Lsun_security_util_DerInputStream_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateValidity']/constructor[@name='CertificateValidity' and count(parameter)=1 and parameter[1][@type='sun.security.util.DerInputStream']]"
		[Register (".ctor", "(Lsun/security/util/DerInputStream;)V", "")]
		public unsafe CertificateValidity (global::Sun.Security.Util.DerInputStream @in)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
...
#pragma warning disable 0169
		...
		{
			global::Sun.Security.X509.CertificateValidity __this = global::Java.Lang.Object.GetObject<global::Sun.Security.X509.CertificateValidity> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Java.Util.IEnumeration Elements {
			// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateValidity']/method[@name='getElements' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Name {
			// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateValidity']/method[@name='getName' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateValidity']/method[@name='delete' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateValidity']/method[@name='encode' and count(parameter)=1 and parameter[1][@type='java.io.OutputStream']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateValidity']/method[@name='get' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateValidity']/method[@name='set' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.Object']]"
		...
		static Delegate cb_valid;
#pragma warning disable 0169
		static Delegate GetValidHandler ()
		{
			if (cb_valid == null)
				cb_valid = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr>) n_Valid);
			return cb_valid;
		}

		static void n_Valid (IntPtr jnienv, IntPtr native__this)
		{
			global::Sun.Security.X509.CertificateValidity __this = global::Java.Lang.Object.GetObject<global::Sun.Security.X509.CertificateValidity> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.Valid ();
		}
#pragma warning restore 0169
		...
		static IntPtr id_valid;
		// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateValidity']/method[@name='valid' and count(parameter)=0]"
		[Register ("valid", "()V", "GetValidHandler")]
		public virtual unsafe void Valid ()
		{
			if (id_valid == IntPtr.Zero)
				id_valid = JNIEnv.GetMethodID (class_ref, "valid", "()V");
			try {

				if (((object) this).GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_valid);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "valid", "()V"));
			} finally {
			}
		}

		static Delegate cb_valid_Ljava_util_Date_;
#pragma warning disable 0169
		static Delegate GetValid_Ljava_util_Date_Handler ()
		{
			if (cb_valid_Ljava_util_Date_ == null)
				cb_valid_Ljava_util_Date_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_Valid_Ljava_util_Date_);
			return cb_valid_Ljava_util_Date_;
		}

		static void n_Valid_Ljava_util_Date_ (IntPtr jnienv, IntPtr native__this, IntPtr native_now)
		{
			global::Sun.Security.X509.CertificateValidity __this = global::Java.Lang.Object.GetObject<global::Sun.Security.X509.CertificateValidity> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Java.Util.Date now = global::Java.Lang.Object.GetObject<global::Java.Util.Date> (native_now, JniHandleOwnership.DoNotTransfer);
			__this.Valid (now);
		}
#pragma warning restore 0169

		static IntPtr id_valid_Ljava_util_Date_;
		// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateValidity']/method[@name='valid' and count(parameter)=1 and parameter[1][@type='java.util.Date']]"
		[Register ("valid", "(Ljava/util/Date;)V", "GetValid_Ljava_util_Date_Handler")]
		public virtual unsafe void Valid (global::Java.Util.Date now)
		{
			if (id_valid_Ljava_util_Date_ == IntPtr.Zero)
				id_valid_Ljava_util_Date_ = JNIEnv.GetMethodID (class_ref, "valid", "(Ljava/util/Date;)V");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (now);

				if (((object) this).GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_valid_Ljava_util_Date_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "valid", "(Ljava/util/Date;)V"), __args);
			} finally {
			}
		}
