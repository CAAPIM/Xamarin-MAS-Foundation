...
namespace Com.CA.Mas.Core.Storage.Implementation {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.ca.mas.core.storage.implementation']/class[@name='AMSAuthenticatorService']"
	[global::Android.Runtime.Register ("com/ca/mas/core/storage/implementation/AMSAuthenticatorService", DoNotGenerateAcw=true)]
	public partial class AMSAuthenticatorService : global::Android.App.Service {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/ca/mas/core/storage/implementation/AMSAuthenticatorService", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (AMSAuthenticatorService); }
		}

		protected AMSAuthenticatorService (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.ca.mas.core.storage.implementation']/class[@name='AMSAuthenticatorService']/constructor[@name='AMSAuthenticatorService' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe AMSAuthenticatorService ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (AMSAuthenticatorService)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.CA.Mas.Core.Storage.Implementation.AMSAuthenticatorService __this = global::Java.Lang.Object.GetObject<global::Com.CA.Mas.Core.Storage.Implementation.AMSAuthenticatorService> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.core.storage.implementation']/class[@name='AMSAuthenticatorService']/method[@name='onBind' and count(parameter)=1 and parameter[1][@type='android.content.Intent']]"
