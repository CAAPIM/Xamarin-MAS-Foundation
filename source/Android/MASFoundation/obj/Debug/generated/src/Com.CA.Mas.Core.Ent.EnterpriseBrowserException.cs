...
namespace Com.CA.Mas.Core.Ent {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.ca.mas.core.ent']/class[@name='EnterpriseBrowserException']"
	[global::Android.Runtime.Register ("com/ca/mas/core/ent/EnterpriseBrowserException", DoNotGenerateAcw=true)]
	public abstract partial class EnterpriseBrowserException : global::Com.CA.Mas.Core.Error.MAGException {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/ca/mas/core/ent/EnterpriseBrowserException", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (EnterpriseBrowserException); }
		}

		protected EnterpriseBrowserException (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_I;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.ca.mas.core.ent']/class[@name='EnterpriseBrowserException']/constructor[@name='EnterpriseBrowserException' and count(parameter)=1 and parameter[1][@type='int']]"
		[Register (".ctor", "(I)V", "")]
		public unsafe EnterpriseBrowserException (int errorCode)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (EnterpriseBrowserException)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.ca.mas.core.ent']/class[@name='EnterpriseBrowserException']/constructor[@name='EnterpriseBrowserException' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='java.lang.String']]"
		[Register (".ctor", "(ILjava/lang/String;)V", "")]
		public unsafe EnterpriseBrowserException (int errorCode, string detailMessage)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Throwable) this).Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.ca.mas.core.ent']/class[@name='EnterpriseBrowserException']/constructor[@name='EnterpriseBrowserException' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='java.lang.Throwable']]"
		[Register (".ctor", "(ILjava/lang/String;Ljava/lang/Throwable;)V", "")]
		public unsafe EnterpriseBrowserException (int errorCode, string detailMessage, global::Java.Lang.Throwable throwable)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Throwable) this).Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.ca.mas.core.ent']/class[@name='EnterpriseBrowserException']/constructor[@name='EnterpriseBrowserException' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='java.lang.Throwable']]"
		[Register (".ctor", "(ILjava/lang/Throwable;)V", "")]
		public unsafe EnterpriseBrowserException (int errorCode, global::Java.Lang.Throwable throwable)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Throwable) this).Handle != IntPtr.Zero)
				return;
	...
	[global::Android.Runtime.Register ("com/ca/mas/core/ent/EnterpriseBrowserException", DoNotGenerateAcw=true)]
	internal partial class EnterpriseBrowserExceptionInvoker : EnterpriseBrowserException {

		public EnterpriseBrowserExceptionInvoker (IntPtr handle, JniHandleOwnership transfer) : base (handle, transfer) {}

		protected override global::System.Type ThresholdType {
			get { return typeof (EnterpriseBrowserExceptionInvoker); }
		}
