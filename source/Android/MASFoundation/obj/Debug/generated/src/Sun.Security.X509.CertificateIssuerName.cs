...
namespace Sun.Security.X509 {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateIssuerName']"
	[global::Android.Runtime.Register ("sun/security/x509/CertificateIssuerName", DoNotGenerateAcw=true)]
	public partial class CertificateIssuerName : global::Java.Lang.Object, global::Sun.Security.X509.ICertAttrSet {


		// Metadata.xml XPath field reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateIssuerName']/field[@name='DN_NAME']"
		[Register ("DN_NAME")]
		public const string DnName = (string) "dname";

		// Metadata.xml XPath field reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateIssuerName']/field[@name='DN_PRINCIPAL']"
		[Register ("DN_PRINCIPAL")]
		public const string DnPrincipal = (string) "x500principal";

		// Metadata.xml XPath field reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateIssuerName']/field[@name='IDENT']"
		[Register ("IDENT")]
		public const string Ident = (string) "x509.info.issuer";
		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("sun/security/x509/CertificateIssuerName", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (CertificateIssuerName); }
		}

		protected CertificateIssuerName (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_io_InputStream_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateIssuerName']/constructor[@name='CertificateIssuerName' and count(parameter)=1 and parameter[1][@type='java.io.InputStream']]"
		[Register (".ctor", "(Ljava/io/InputStream;)V", "")]
		public unsafe CertificateIssuerName (global::System.IO.Stream @in)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (CertificateIssuerName)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateIssuerName']/constructor[@name='CertificateIssuerName' and count(parameter)=1 and parameter[1][@type='sun.security.util.DerInputStream']]"
		[Register (".ctor", "(Lsun/security/util/DerInputStream;)V", "")]
		public unsafe CertificateIssuerName (global::Sun.Security.Util.DerInputStream @in)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateIssuerName']/constructor[@name='CertificateIssuerName' and count(parameter)=1 and parameter[1][@type='sun.security.x509.X500Name']]"
		[Register (".ctor", "(Lsun/security/x509/X500Name;)V", "")]
		public unsafe CertificateIssuerName (global::Sun.Security.X509.X500Name name)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
...
#pragma warning disable 0169
		...
		{
			global::Sun.Security.X509.CertificateIssuerName __this = global::Java.Lang.Object.GetObject<global::Sun.Security.X509.CertificateIssuerName> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Java.Util.IEnumeration Elements {
			// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateIssuerName']/method[@name='getElements' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Name {
			// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateIssuerName']/method[@name='getName' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateIssuerName']/method[@name='delete' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateIssuerName']/method[@name='encode' and count(parameter)=1 and parameter[1][@type='java.io.OutputStream']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateIssuerName']/method[@name='get' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateIssuerName']/method[@name='set' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.Object']]"
