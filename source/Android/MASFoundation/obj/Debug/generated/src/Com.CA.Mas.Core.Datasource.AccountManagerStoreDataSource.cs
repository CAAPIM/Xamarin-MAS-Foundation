...
namespace Com.CA.Mas.Core.Datasource {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.ca.mas.core.datasource']/class[@name='AccountManagerStoreDataSource']"
	[global::Android.Runtime.Register ("com/ca/mas/core/datasource/AccountManagerStoreDataSource", DoNotGenerateAcw=true)]
	[global::Java.Interop.JavaTypeParameters (new string [] {"K", "V"})]
	public partial class AccountManagerStoreDataSource : global::Java.Lang.Object, global::Com.CA.Mas.Core.Datasource.IDataSource {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/ca/mas/core/datasource/AccountManagerStoreDataSource", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (AccountManagerStoreDataSource); }
		}

		protected AccountManagerStoreDataSource (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Landroid_content_Context_Lorg_json_JSONObject_Lcom_ca_mas_core_datasource_DataConverter_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.ca.mas.core.datasource']/class[@name='AccountManagerStoreDataSource']/constructor[@name='AccountManagerStoreDataSource' and count(parameter)=3 and parameter[1][@type='android.content.Context'] and parameter[2][@type='org.json.JSONObject'] and parameter[3][@type='com.ca.mas.core.datasource.DataConverter']]"
		[Register (".ctor", "(Landroid/content/Context;Lorg/json/JSONObject;Lcom/ca/mas/core/datasource/DataConverter;)V", "")]
		public unsafe AccountManagerStoreDataSource (global::Android.Content.Context context, global::Org.Json.JSONObject param, global::Com.CA.Mas.Core.Datasource.IDataConverter converter)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (AccountManagerStoreDataSource)) {
					SetHandle (
		...
		static Delegate cb_getConverter;
#pragma warning disable 0169
		static Delegate GetGetConverterHandler ()
		{
			if (cb_getConverter == null)
				cb_getConverter = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n_GetConverter);
			return cb_getConverter;
		}

		static IntPtr n_GetConverter (IntPtr jnienv, IntPtr native__this)
		{
			global::Com.CA.Mas.Core.Datasource.AccountManagerStoreDataSource __this = global::Java.Lang.Object.GetObject<global::Com.CA.Mas.Core.Datasource.AccountManagerStoreDataSource> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.ToLocalJniHandle (__this.Converter);
		}
#pragma warning restore 0169

		static IntPtr id_getConverter;
		protected virtual unsafe global::Com.CA.Mas.Core.Datasource.IDataConverter Converter {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.core.datasource']/class[@name='AccountManagerStoreDataSource']/method[@name='getConverter' and count(parameter)=0]"
			[Register ("getConverter", "()Lcom/ca/mas/core/datasource/DataConverter;", "GetGetConverterHandler")]
			get {
				if (id_getConverter == IntPtr.Zero)
					id_getConverter = JNIEnv.GetMethodID (class_ref, "getConverter", "()Lcom/ca/mas/core/datasource/DataConverter;");
				try {

					if (((object) this).GetType () == ThresholdType)
						return global::Java.Lang.Object.GetObject<global::Com.CA.Mas.Core.Datasource.IDataConverter> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_getConverter), JniHandleOwnership.TransferLocalRef);
					else
						return global::Java.Lang.Object.GetObject<global::Com.CA.Mas.Core.Datasource.IDataConverter> (JNIEnv.CallNonvirtualObjectMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getConverter", "()Lcom/ca/mas/core/datasource/DataConverter;")), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe bool IsReady {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.core.datasource']/class[@name='AccountManagerStoreDataSource']/method[@name='isReady' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.core.datasource']/class[@name='AccountManagerStoreDataSource']/method[@name='get' and count(parameter)=1 and parameter[1][@type='K']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.core.datasource']/class[@name='AccountManagerStoreDataSource']/method[@name='get' and count(parameter)=2 and parameter[1][@type='K'] and parameter[2][@type='com.ca.mas.core.datasource.DataSourceCallback']]"
		...
		static Delegate cb_getData_Ljava_lang_Object_Lcom_ca_mas_core_storage_StorageResult_;
#pragma warning disable 0169
		static Delegate GetGetData_Ljava_lang_Object_Lcom_ca_mas_core_storage_StorageResult_Handler ()
		{
			if (cb_getData_Ljava_lang_Object_Lcom_ca_mas_core_storage_StorageResult_ == null)
				cb_getData_Ljava_lang_Object_Lcom_ca_mas_core_storage_StorageResult_ = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr, IntPtr, IntPtr>) n_GetData_Ljava_lang_Object_Lcom_ca_mas_core_storage_StorageResult_);
			return cb_getData_Ljava_lang_Object_Lcom_ca_mas_core_storage_StorageResult_;
		}

		static IntPtr n_GetData_Ljava_lang_Object_Lcom_ca_mas_core_storage_StorageResult_ (IntPtr jnienv, IntPtr native__this, IntPtr native_key, IntPtr native_result)
		{
			global::Com.CA.Mas.Core.Datasource.AccountManagerStoreDataSource __this = global::Java.Lang.Object.GetObject<global::Com.CA.Mas.Core.Datasource.AccountManagerStoreDataSource> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Java.Lang.Object key = global::Java.Lang.Object.GetObject<global::Java.Lang.Object> (native_key, JniHandleOwnership.DoNotTransfer);
			...
			IntPtr __ret = JNIEnv.ToLocalJniHandle (__this.GetData (key, result));
			return __ret;
		}
#pragma warning restore 0169

		static IntPtr id_getData_Ljava_lang_Object_Lcom_ca_mas_core_storage_StorageResult_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.core.datasource']/class[@name='AccountManagerStoreDataSource']/method[@name='getData' and count(parameter)=2 and parameter[1][@type='K'] and parameter[2][@type='com.ca.mas.core.storage.StorageResult']]"
		[Register ("getData", "(Ljava/lang/Object;Lcom/ca/mas/core/storage/StorageResult;)Ljava/lang/Object;", "GetGetData_Ljava_lang_Object_Lcom_ca_mas_core_storage_StorageResult_Handler")]
		protected virtual unsafe global::Java.Lang.Object GetData (global::Java.Lang.Object key, global::Com.CA.Mas.Core.Storage.StorageResult result)
		{
			if (id_getData_Ljava_lang_Object_Lcom_ca_mas_core_storage_StorageResult_ == IntPtr.Zero)
				id_getData_Ljava_lang_Object_Lcom_ca_mas_core_storage_StorageResult_ = JNIEnv.GetMethodID (class_ref, "getData", "(Ljava/lang/Object;Lcom/ca/mas/core/storage/StorageResult;)Ljava/lang/Object;");
			IntPtr native_key = JNIEnv.ToLocalJniHandle (key);
			try {
				JValue* __args = stackalloc JValue [2];
				__args [0] = new JValue (native_key);
				...
				global::Java.Lang.Object __ret;
				if (((object) this).GetType () == ThresholdType)
					__ret = (Java.Lang.Object) global::Java.Lang.Object.GetObject<global::Java.Lang.Object> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_getData_Ljava_lang_Object_Lcom_ca_mas_core_storage_StorageResult_, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = (Java.Lang.Object) global::Java.Lang.Object.GetObject<global::Java.Lang.Object> (JNIEnv.CallNonvirtualObjectMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getData", "(Ljava/lang/Object;Lcom/ca/mas/core/storage/StorageResult;)Ljava/lang/Object;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
				JNIEnv.DeleteLocalRef (native_key);
			}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.core.datasource']/class[@name='AccountManagerStoreDataSource']/method[@name='getKeys' and count(parameter)=1 and parameter[1][@type='java.lang.Object']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.core.datasource']/class[@name='AccountManagerStoreDataSource']/method[@name='getKeys' and count(parameter)=2 and parameter[1][@type='java.lang.Object'] and parameter[2][@type='com.ca.mas.core.datasource.DataSourceCallback']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.core.datasource']/class[@name='AccountManagerStoreDataSource']/method[@name='put' and count(parameter)=2 and parameter[1][@type='K'] and parameter[2][@type='V']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.core.datasource']/class[@name='AccountManagerStoreDataSource']/method[@name='put' and count(parameter)=3 and parameter[1][@type='K'] and parameter[2][@type='V'] and parameter[3][@type='com.ca.mas.core.datasource.DataSourceCallback']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.core.datasource']/class[@name='AccountManagerStoreDataSource']/method[@name='remove' and count(parameter)=1 and parameter[1][@type='K']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.core.datasource']/class[@name='AccountManagerStoreDataSource']/method[@name='remove' and count(parameter)=2 and parameter[1][@type='K'] and parameter[2][@type='com.ca.mas.core.datasource.DataSourceCallback']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.core.datasource']/class[@name='AccountManagerStoreDataSource']/method[@name='removeAll' and count(parameter)=1 and parameter[1][@type='java.lang.Object']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.core.datasource']/class[@name='AccountManagerStoreDataSource']/method[@name='removeAll' and count(parameter)=2 and parameter[1][@type='java.lang.Object'] and parameter[2][@type='com.ca.mas.core.datasource.DataSourceCallback']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.core.datasource']/class[@name='AccountManagerStoreDataSource']/method[@name='unlock' and count(parameter)=0]"
