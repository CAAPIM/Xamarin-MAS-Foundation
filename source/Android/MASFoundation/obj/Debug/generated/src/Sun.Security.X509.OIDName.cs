...
namespace Sun.Security.X509 {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='sun.security.x509']/class[@name='OIDName']"
	[global::Android.Runtime.Register ("sun/security/x509/OIDName", DoNotGenerateAcw=true)]
	public partial class OIDName : global::Java.Lang.Object, global::Sun.Security.X509.IGeneralNameInterface {
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("sun/security/x509/OIDName", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (OIDName); }
		}

		protected OIDName (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='sun.security.x509']/class[@name='OIDName']/constructor[@name='OIDName' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;)V", "")]
		public unsafe OIDName (string name)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (OIDName)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='sun.security.x509']/class[@name='OIDName']/constructor[@name='OIDName' and count(parameter)=1 and parameter[1][@type='sun.security.util.ObjectIdentifier']]"
		[Register (".ctor", "(Lsun/security/util/ObjectIdentifier;)V", "")]
		public unsafe OIDName (global::Sun.Security.Util.ObjectIdentifier oid)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
...
#pragma warning disable 0169
		...
		{
			global::Sun.Security.X509.OIDName __this = global::Java.Lang.Object.GetObject<global::Sun.Security.X509.OIDName> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Sun.Security.Util.ObjectIdentifier OID {
			// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='OIDName']/method[@name='getOID' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe int Type {
			// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='OIDName']/method[@name='getType' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='OIDName']/method[@name='constrains' and count(parameter)=1 and parameter[1][@type='sun.security.x509.GeneralNameInterface']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='OIDName']/method[@name='encode' and count(parameter)=1 and parameter[1][@type='sun.security.util.DerOutputStream']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='OIDName']/method[@name='subtreeDepth' and count(parameter)=0]"
