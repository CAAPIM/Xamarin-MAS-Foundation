...
namespace Com.CA.Mas.Foundation {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.ca.mas.foundation']/class[@name='MASTokenRequest']"
	[global::Android.Runtime.Register ("com/ca/mas/foundation/MASTokenRequest", DoNotGenerateAcw=true)]
	public partial class MASTokenRequest : global::Java.Lang.Object {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/ca/mas/foundation/MASTokenRequest", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (MASTokenRequest); }
		}

		protected MASTokenRequest (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.ca.mas.foundation']/class[@name='MASTokenRequest']/constructor[@name='MASTokenRequest' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe MASTokenRequest ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (MASTokenRequest)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.CA.Mas.Foundation.MASTokenRequest __this = global::Java.Lang.Object.GetObject<global::Com.CA.Mas.Foundation.MASTokenRequest> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Com.CA.Mas.Core.Http.MAGRequestBody Body {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.foundation']/class[@name='MASTokenRequest']/method[@name='getBody' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Com.CA.Mas.Core.Oauth.GrantProvider GrantProvider {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.foundation']/class[@name='MASTokenRequest']/method[@name='getGrantProvider' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe global::System.Collections.Generic.IDictionary<string, global::System.Collections.Generic.IList<string>> Headers {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.foundation']/class[@name='MASTokenRequest']/method[@name='getHeaders' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe bool IsPublic {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.foundation']/class[@name='MASTokenRequest']/method[@name='isPublic' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Method {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.foundation']/class[@name='MASTokenRequest']/method[@name='getMethod' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Scope {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.foundation']/class[@name='MASTokenRequest']/method[@name='getScope' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Java.Net.URL URL {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.foundation']/class[@name='MASTokenRequest']/method[@name='getURL' and count(parameter)=0]"
		...
		static Delegate cb_notifyOnCancel;
#pragma warning disable 0169
		static Delegate GetNotifyOnCancelHandler ()
		{
			if (cb_notifyOnCancel == null)
				cb_notifyOnCancel = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, bool>) n_NotifyOnCancel);
			return cb_notifyOnCancel;
		}

		static bool n_NotifyOnCancel (IntPtr jnienv, IntPtr native__this)
		{
			global::Com.CA.Mas.Foundation.MASTokenRequest __this = global::Java.Lang.Object.GetObject<global::Com.CA.Mas.Foundation.MASTokenRequest> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.NotifyOnCancel ();
		}
#pragma warning restore 0169

		static IntPtr id_notifyOnCancel;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.foundation']/class[@name='MASTokenRequest']/method[@name='notifyOnCancel' and count(parameter)=0]"
		[Register ("notifyOnCancel", "()Z", "GetNotifyOnCancelHandler")]
		public virtual unsafe bool NotifyOnCancel ()
		{
			if (id_notifyOnCancel == IntPtr.Zero)
				id_notifyOnCancel = JNIEnv.GetMethodID (class_ref, "notifyOnCancel", "()Z");
			try {

				if (((object) this).GetType () == ThresholdType)
					return JNIEnv.CallBooleanMethod (((global::Java.Lang.Object) this).Handle, id_notifyOnCancel);
				else
					return JNIEnv.CallNonvirtualBooleanMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "notifyOnCancel", "()Z"));
			} finally {
			}
		}
