...
namespace Com.CA.Mas.Foundation {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.ca.mas.foundation']/class[@name='MASServerException']"
	[global::Android.Runtime.Register ("com/ca/mas/foundation/MASServerException", DoNotGenerateAcw=true)]
	public partial class MASServerException : global::Com.CA.Mas.Core.Error.MAGServerException {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/ca/mas/foundation/MASServerException", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (MASServerException); }
		}

		protected MASServerException (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Lcom_ca_mas_core_error_MAGServerException_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.ca.mas.foundation']/class[@name='MASServerException']/constructor[@name='MASServerException' and count(parameter)=1 and parameter[1][@type='com.ca.mas.core.error.MAGServerException']]"
		[Register (".ctor", "(Lcom/ca/mas/core/error/MAGServerException;)V", "")]
		public unsafe MASServerException (global::Com.CA.Mas.Core.Error.MAGServerException e)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (MASServerException)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.ca.mas.foundation']/class[@name='MASServerException']/constructor[@name='MASServerException' and count(parameter)=4 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='java.lang.String'] and parameter[4][@type='java.lang.String']]"
		[Register (".ctor", "(IILjava/lang/String;Ljava/lang/String;)V", "")]
		public unsafe MASServerException (int errorCode, int status, string contentType, string detailMessage)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Throwable) this).Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.ca.mas.foundation']/class[@name='MASServerException']/constructor[@name='MASServerException' and count(parameter)=5 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='java.lang.String'] and parameter[4][@type='java.lang.String'] and parameter[5][@type='java.lang.Throwable']]"
		[Register (".ctor", "(IILjava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V", "")]
		public unsafe MASServerException (int errorCode, int status, string contentType, string detailMessage, global::Java.Lang.Throwable throwable)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Throwable) this).Handle != IntPtr.Zero)
				return;
