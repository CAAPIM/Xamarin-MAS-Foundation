...
namespace Com.CA.Mas.Foundation.Auth {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.ca.mas.foundation.auth']/class[@name='MASProximityLoginQRCode']"
	[global::Android.Runtime.Register ("com/ca/mas/foundation/auth/MASProximityLoginQRCode", DoNotGenerateAcw=true)]
	public partial class MASProximityLoginQRCode : global::Com.CA.Mas.Core.Auth.QRCodeRenderer, global::Com.CA.Mas.Foundation.Auth.IMASProximityLogin {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/ca/mas/foundation/auth/MASProximityLoginQRCode", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (MASProximityLoginQRCode); }
		}

		protected MASProximityLoginQRCode (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.ca.mas.foundation.auth']/class[@name='MASProximityLoginQRCode']/constructor[@name='MASProximityLoginQRCode' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe MASProximityLoginQRCode ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (MASProximityLoginQRCode)) {
					SetHandle (
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.foundation.auth']/class[@name='MASProximityLoginQRCode']/method[@name='authorize' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='com.ca.mas.foundation.MASCallback&lt;java.lang.Void&gt;']]"
...
#pragma warning disable 0169
		...
		{
			global::Com.CA.Mas.Foundation.Auth.MASProximityLoginQRCode __this = global::Java.Lang.Object.GetObject<global::Com.CA.Mas.Foundation.Auth.MASProximityLoginQRCode> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.foundation.auth']/class[@name='MASProximityLoginQRCode']/method[@name='init' and count(parameter)=3 and parameter[1][@type='android.app.Activity'] and parameter[2][@type='long'] and parameter[3][@type='com.ca.mas.foundation.auth.MASAuthenticationProviders']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.foundation.auth']/class[@name='MASProximityLoginQRCode']/method[@name='start' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.foundation.auth']/class[@name='MASProximityLoginQRCode']/method[@name='stop' and count(parameter)=0]"
