...
namespace Sun.Security.X509 {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateAlgorithmId']"
	[global::Android.Runtime.Register ("sun/security/x509/CertificateAlgorithmId", DoNotGenerateAcw=true)]
	public partial class CertificateAlgorithmId : global::Java.Lang.Object, global::Sun.Security.X509.ICertAttrSet {


		// Metadata.xml XPath field reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateAlgorithmId']/field[@name='ALGORITHM']"
		[Register ("ALGORITHM")]
		public const string Algorithm = (string) "algorithm";

		// Metadata.xml XPath field reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateAlgorithmId']/field[@name='IDENT']"
		[Register ("IDENT")]
		public const string Ident = (string) "x509.info.algorithmID";
		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("sun/security/x509/CertificateAlgorithmId", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (CertificateAlgorithmId); }
		}

		protected CertificateAlgorithmId (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_io_InputStream_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateAlgorithmId']/constructor[@name='CertificateAlgorithmId' and count(parameter)=1 and parameter[1][@type='java.io.InputStream']]"
		[Register (".ctor", "(Ljava/io/InputStream;)V", "")]
		public unsafe CertificateAlgorithmId (global::System.IO.Stream @in)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (CertificateAlgorithmId)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateAlgorithmId']/constructor[@name='CertificateAlgorithmId' and count(parameter)=1 and parameter[1][@type='sun.security.util.DerInputStream']]"
		[Register (".ctor", "(Lsun/security/util/DerInputStream;)V", "")]
		public unsafe CertificateAlgorithmId (global::Sun.Security.Util.DerInputStream @in)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
		...
		static IntPtr id_ctor_Lsun_security_x509_AlgorithmId_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateAlgorithmId']/constructor[@name='CertificateAlgorithmId' and count(parameter)=1 and parameter[1][@type='sun.security.x509.AlgorithmId']]"
		[Register (".ctor", "(Lsun/security/x509/AlgorithmId;)V", "")]
		public unsafe CertificateAlgorithmId (global::Sun.Security.X509.AlgorithmId algId)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (algId);
				if (((object) this).GetType () != typeof (CertificateAlgorithmId)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Lsun/security/x509/AlgorithmId;)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, "(Lsun/security/x509/AlgorithmId;)V", __args);
					return;
				}

				if (id_ctor_Lsun_security_x509_AlgorithmId_ == IntPtr.Zero)
					id_ctor_Lsun_security_x509_AlgorithmId_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Lsun/security/x509/AlgorithmId;)V");
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Lsun_security_x509_AlgorithmId_, __args),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, class_ref, id_ctor_Lsun_security_x509_AlgorithmId_, __args);
			} finally {
			}
		}
...
#pragma warning disable 0169
		...
		{
			global::Sun.Security.X509.CertificateAlgorithmId __this = global::Java.Lang.Object.GetObject<global::Sun.Security.X509.CertificateAlgorithmId> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Java.Util.IEnumeration Elements {
			// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateAlgorithmId']/method[@name='getElements' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Name {
			// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateAlgorithmId']/method[@name='getName' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateAlgorithmId']/method[@name='delete' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateAlgorithmId']/method[@name='encode' and count(parameter)=1 and parameter[1][@type='java.io.OutputStream']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateAlgorithmId']/method[@name='get' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='sun.security.x509']/class[@name='CertificateAlgorithmId']/method[@name='set' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.Object']]"
