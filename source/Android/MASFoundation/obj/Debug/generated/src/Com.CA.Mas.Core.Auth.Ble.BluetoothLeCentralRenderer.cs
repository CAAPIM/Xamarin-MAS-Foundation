...
namespace Com.CA.Mas.Core.Auth.Ble {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.ca.mas.core.auth.ble']/class[@name='BluetoothLeCentralRenderer']"
	[global::Android.Runtime.Register ("com/ca/mas/core/auth/ble/BluetoothLeCentralRenderer", DoNotGenerateAcw=true)]
	public partial class BluetoothLeCentralRenderer : global::Com.CA.Mas.Core.Auth.PollingRenderer {


		// Metadata.xml XPath field reference: path="/api/package[@name='com.ca.mas.core.auth.ble']/class[@name='BluetoothLeCentralRenderer']/field[@name='MAX']"
		[Register ("MAX")]
		public const int Max = (int) 20;
		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/ca/mas/core/auth/ble/BluetoothLeCentralRenderer", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (BluetoothLeCentralRenderer); }
		}

		protected BluetoothLeCentralRenderer (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Lcom_ca_mas_core_auth_ble_BluetoothLeCentralCallback_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.ca.mas.core.auth.ble']/class[@name='BluetoothLeCentralRenderer']/constructor[@name='BluetoothLeCentralRenderer' and count(parameter)=1 and parameter[1][@type='com.ca.mas.core.auth.ble.BluetoothLeCentralCallback']]"
		[Register (".ctor", "(Lcom/ca/mas/core/auth/ble/BluetoothLeCentralCallback;)V", "")]
		public unsafe BluetoothLeCentralRenderer (global::Com.CA.Mas.Core.Auth.Ble.IBluetoothLeCentralCallback @callback)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (BluetoothLeCentralRenderer)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Lcom/ca/mas/core/auth/ble/BluetoothLeCentralCallback;)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, "(Lcom/ca/mas/core/auth/ble/BluetoothLeCentralCallback;)V", __args);
					return;
				}

				if (id_ctor_Lcom_ca_mas_core_auth_ble_BluetoothLeCentralCallback_ == IntPtr.Zero)
					id_ctor_Lcom_ca_mas_core_auth_ble_BluetoothLeCentralCallback_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Lcom/ca/mas/core/auth/ble/BluetoothLeCentralCallback;)V");
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Lcom_ca_mas_core_auth_ble_BluetoothLeCentralCallback_, __args),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, class_ref, id_ctor_Lcom_ca_mas_core_auth_ble_BluetoothLeCentralCallback_, __args);
			} finally {
			}
		}
...
#pragma warning disable 0169
		...
		{
			global::Com.CA.Mas.Core.Auth.Ble.BluetoothLeCentralRenderer __this = global::Java.Lang.Object.GetObject<global::Com.CA.Mas.Core.Auth.Ble.BluetoothLeCentralRenderer> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.core.auth.ble']/class[@name='BluetoothLeCentralRenderer']/method[@name='onError' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='java.lang.Exception']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.core.auth.ble']/class[@name='BluetoothLeCentralRenderer']/method[@name='render' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ca.mas.core.auth.ble']/class[@name='BluetoothLeCentralRenderer']/method[@name='startPollingOnStartup' and count(parameter)=0]"
